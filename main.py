...
def main():
    ...
    network_pkl = 'networks/generator_yellow-stylegan2-config-f.pkl'     # 黄种人的脸
#   network_pkl = 'generator_star-stylegan2-config-f.pkl'                # 明星脸
#   network_pkl = 'generator_wanghong-stylegan2-config-f.pkl'            # 网红脸
#   network_pkl = 'generator_baby-stylegan2-config-f.pkl'                # 娃娃脸
